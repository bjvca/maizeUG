...
res_pract_mm[1,3,h]  <- ifelse(totrep >0, RI("space_mm",treatment, dta_bal, nr_repl = totrep),  summary(lm(as.formula(paste("space_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,4])

## used recommended way to fight striga - this should be changed to include info of all plots 
res_pract_mm[2,1,h]  <- summary(lm(as.formula(paste("striga_mm", treatment, sep ="~")), data=dta_bal))$coefficients[1,1]
res_pract_mm[2,2,h]  <- summary(lm(as.formula(paste("striga_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,1]
res_pract_mm[2,3,h]  <- ifelse(totrep >0, RI("striga_mm",treatment , dta_bal, nr_repl = totrep), summary(lm(as.formula(paste("striga_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,4])

## weeded on recommended timing? - this should be changed to include info of all plots 
res_pract_mm[3,1,h]  <- summary(lm(as.formula(paste("weed_mm", treatment, sep ="~")), data=dta_bal))$coefficients[1,1]
res_pract_mm[3,2,h]  <- summary(lm(as.formula(paste("weed_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,1]
res_pract_mm[3,3,h]  <- ifelse(totrep >0, RI("weed_mm",treatment, dta_bal, nr_repl = totrep),summary(lm(as.formula(paste("weed_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,4])

## fertilizer use
res_pract_mm[4,1,h]  <- summary(lm(as.formula(paste("fert_mm", treatment, sep ="~")), data=dta_bal))$coefficients[1,1]
res_pract_mm[4,2,h]  <- summary(lm(as.formula(paste("fert_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,1]
res_pract_mm[4,3,h]  <- ifelse(totrep >0, RI("fert_mm",treatment , dta_bal, nr_repl = totrep), summary(lm(as.formula(paste("fert_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,4]) 
#### fert = DAP/NPK
res_pract_mm[5,1,h]  <- summary(lm(as.formula(paste("fert_dap_mm", treatment, sep ="~")), data=dta_bal))$coefficients[1,1]
res_pract_mm[5,2,h]  <- summary(lm(as.formula(paste("fert_dap_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,1]
res_pract_mm[5,3,h]  <- ifelse(totrep >0, RI("fert_dap_mm",treatment , dta_bal, nr_repl = totrep) , summary(lm(as.formula(paste("fert_dap_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,4])

#### fert = urea
res_pract_mm[6,1,h]  <- summary(lm(as.formula(paste("fert_urea_mm", treatment, sep ="~")), data=dta_bal))$coefficients[1,1]
res_pract_mm[6,2,h]  <- summary(lm(as.formula(paste("fert_urea_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,1]
res_pract_mm[6,3,h]  <- ifelse(totrep >0, RI("fert_urea_mm",treatment , dta_bal, nr_repl = totrep) , summary(lm(as.formula(paste("fert_urea_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,4])

#### fert = organic
res_pract_mm[7,1,h]  <-  summary(lm(as.formula(paste("fert_org_mm", treatment, sep ="~")), data=dta_bal))$coefficients[1,1]
res_pract_mm[7,2,h]  <- summary(lm(as.formula(paste("fert_org_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,1]
res_pract_mm[7,3,h]  <- ifelse(totrep >0, RI("fert_org_mm",treatment , dta_bal, nr_repl = totrep), summary(lm(as.formula(paste("fert_org_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,4]) 

##improved seed  
res_pract_mm[8,1,h]  <- summary(lm(as.formula(paste("impseed_mm", treatment, sep ="~")), data=dta_bal))$coefficients[1,1]
res_pract_mm[8,2,h]  <- summary(lm(as.formula(paste("impseed_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,1]
res_pract_mm[8,3,h]  <- ifelse(totrep >0, RI("impseed_mm",treatment , dta_bal, nr_repl = totrep),  summary(lm(as.formula(paste("impseed_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,4]) 


## hybrid
res_pract_mm[9,1,h] <- summary(lm(as.formula(paste("hybrid_mm", treatment, sep ="~")), data=dta_bal))$coefficients[1,1]
res_pract_mm[9,2,h] <- summary(lm(as.formula(paste("hybrid_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,1]
res_pract_mm[9,3,h] <- ifelse(totrep >0, RI("hybrid_mm",treatment , dta_bal, nr_repl = totrep), summary(lm(as.formula(paste("hybrid_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,4]) 

## opv
res_pract_mm[10,1,h] <- summary(lm(as.formula(paste("opv_mm", treatment, sep ="~")), data=dta_bal))$coefficients[1,1]
res_pract_mm[10,2,h] <- summary(lm(as.formula(paste("opv_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,1]
res_pract_mm[10,3,h] <- ifelse(totrep >0, RI("opv_mm",treatment , dta_bal, nr_repl = totrep), summary(lm(as.formula(paste("opv_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,4]) 

##combiner
res_pract_mm[11,1,h]  <- summary(lm(as.formula(paste("combiner_mm", treatment, sep ="~")), data=dta_bal))$coefficients[1,1]
res_pract_mm[11,2,h]  <- summary(lm(as.formula(paste("combiner_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,1]
res_pract_mm[11,3,h]  <- ifelse(totrep >0, RI("combiner_mm",treatment , dta_bal, nr_repl = totrep), summary(lm(as.formula(paste("combiner_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,4]) 

### bought seed
res_pract_mm[12,1,h]  <- summary(lm(as.formula(paste("bought_seed_mm", treatment, sep ="~")), data=dta_bal))$coefficients[1,1]
res_pract_mm[12,2,h]  <- summary(lm(as.formula(paste("bought_seed_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,1]
res_pract_mm[12,3,h]  <- ifelse(totrep >0, RI("bought_seed_mm",treatment , dta_bal, nr_repl = totrep), summary(lm(as.formula(paste("bought_seed_mm", treatment, sep ="~")), data=dta_bal))$coefficients[2,4]) 
