...
res_prod <- array(NA, c(8,4,7)) 
rownames(res_prod) <- c("prod","","area","", "yield better","","yield","")
res_prod_m <- array(NA, c(8,4,7)) 
rownames(res_prod_m) <- c("prod","","area","", "yield better","","yield","")
res_prod_w <- array(NA, c(8,4,7)) 
rownames(res_prod_w) <- c("prod","","area","", "yield better","","yield","")
...
res_prod[3,1,h] <- ifelse(h ==1, wtd.mean(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.mean(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.mean(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod[4,1,h] <- ifelse(h ==1, wtd.sd(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.sd(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.sd(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod[3,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,1],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,1])
res_prod[4,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,2],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,2])
res_prod[3,3,h] <- ifelse(totrep >0, RI_plot("mgt_man",treatment , ctrls,w_int="weights", dta_ind, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,4],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta_ind))$coefficients[2,4]))
res_prod[4,3,h] <- nobs(lm(as.formula(paste("outcome",treatment, sep="~")) ,data=dta_ind))
...
res_prod[5,1,h] <- ifelse(h ==1, wtd.mean(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.mean(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.mean(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod[6,1,h] <- ifelse(h ==1, wtd.sd(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.sd(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.sd(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod[5,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,1],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,1])
res_prod[6,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,2],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,2])
res_prod[5,3,h] <- ifelse(totrep >0, RI_plot("mgt_man",treatment , ctrls,w_int="weights", dta_ind, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,4],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta_ind))$coefficients[2,4]))
res_prod[6,3,h] <- nobs(lm(as.formula(paste("outcome",treatment, sep="~")) ,data=dta_ind))
...
res_prod[7,1,h] <- ifelse(h ==1, wtd.mean(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.mean(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.mean(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod[8,1,h] <- ifelse(h ==1, wtd.sd(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.sd(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.sd(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod[7,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,1],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,1])
res_prod[8,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,2],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,2])
res_prod[7,3,h] <- ifelse(totrep >0, RI_plot("mgt_man",treatment , ctrls,w_int="weights", dta_ind, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,4],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta_ind))$coefficients[2,4]))
res_prod[8,3,h] <- nobs(lm(as.formula(paste("outcome",treatment, sep="~")) ,data=dta_ind))
...
res_prod_w[1,1,h] <- ifelse(h ==1, wtd.mean(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.mean(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.mean(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod_w[2,1,h] <- ifelse(h ==1, wtd.sd(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.sd(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.sd(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod_w[1,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,1],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,1])
res_prod_w[2,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,2],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,2])
res_prod_w[1,3,h] <- ifelse(totrep >0, RI_plot("mgt_man",treatment , ctrls,w_int="weights", dta_ind, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,4],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta_ind))$coefficients[2,4]))
res_prod_w[2,3,h] <- nobs(lm(as.formula(paste("outcome",treatment, sep="~")) ,data=dta_ind))
...
res_prod_w[3,1,h] <- ifelse(h ==1, wtd.mean(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.mean(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.mean(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod_w[4,1,h] <- ifelse(h ==1, wtd.sd(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.sd(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.sd(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod_w[3,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,1],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,1])
res_prod_w[4,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,2],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,2])
res_prod_w[3,3,h] <- ifelse(totrep >0, RI_plot("mgt_man",treatment , ctrls,w_int="weights", dta_ind, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,4],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta_ind))$coefficients[2,4]))
res_prod_w[4,3,h] <- nobs(lm(as.formula(paste("outcome",treatment, sep="~")) ,data=dta_ind))
...
res_prod_w[5,1,h] <- ifelse(h ==1, wtd.mean(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.mean(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.mean(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod_w[6,1,h] <- ifelse(h ==1, wtd.sd(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.sd(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.sd(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod_w[5,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,1],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,1])
res_prod_w[6,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,2],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,2])
res_prod_w[5,3,h] <- ifelse(totrep >0, RI_plot("mgt_man",treatment , ctrls,w_int="weights", dta_ind, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,4],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta_ind))$coefficients[2,4]))
res_prod_w[6,3,h] <- nobs(lm(as.formula(paste("outcome",treatment, sep="~")) ,data=dta_ind))
...
res_prod_w[7,1,h] <- ifelse(h ==1, wtd.mean(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.mean(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.mean(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod_w[8,1,h] <- ifelse(h ==1, wtd.sd(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.sd(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.sd(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod_w[7,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,1],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,1])
res_prod_w[8,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,2],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,2])
res_prod_w[7,3,h] <- ifelse(totrep >0, RI_plot("mgt_man",treatment , ctrls,w_int="weights", dta_ind, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,4],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta_ind))$coefficients[2,4]))
res_prod_w[8,3,h] <- nobs(lm(as.formula(paste("outcome",treatment, sep="~")) ,data=dta_ind))
...
res_prod_m[1,1,h] <- ifelse(h ==1, wtd.mean(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.mean(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.mean(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod_m[2,1,h] <- ifelse(h ==1, wtd.sd(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.sd(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.sd(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod_m[1,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,1],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,1])
res_prod_m[2,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,2],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,2])
res_prod_m[1,3,h] <- ifelse(totrep >0, RI_plot("mgt_man",treatment , ctrls,w_int="weights", dta_ind, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,4],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta_ind))$coefficients[2,4]))
res_prod_m[2,3,h] <- nobs(lm(as.formula(paste("outcome",treatment, sep="~")) ,data=dta_ind))
...
res_prod_m[3,1,h] <- ifelse(h ==1, wtd.mean(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.mean(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.mean(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod_m[4,1,h] <- ifelse(h ==1, wtd.sd(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.sd(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.sd(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod_m[3,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,1],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,1])
res_prod_m[4,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,2],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,2])
res_prod_m[3,3,h] <- ifelse(totrep >0, RI_plot("mgt_man",treatment , ctrls,w_int="weights", dta_ind, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,4],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta_ind))$coefficients[2,4]))
res_prod_m[4,3,h] <- nobs(lm(as.formula(paste("outcome",treatment, sep="~")) ,data=dta_ind))
...
res_prod_m[5,1,h] <- ifelse(h ==1, wtd.mean(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.mean(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.mean(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod_m[6,1,h] <- ifelse(h ==1, wtd.sd(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.sd(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.sd(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod_m[5,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,1],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,1])
res_prod_m[6,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,2],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,2])
res_prod_m[5,3,h] <- ifelse(totrep >0, RI_plot("mgt_man",treatment , ctrls,w_int="weights", dta_ind, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,4],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta_ind))$coefficients[2,4]))
res_prod_m[6,3,h] <- nobs(lm(as.formula(paste("outcome",treatment, sep="~")) ,data=dta_ind))
...
res_prod_m[7,1,h] <- ifelse(h ==1, wtd.mean(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.mean(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.mean(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod_m[8,1,h] <- ifelse(h ==1, wtd.sd(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.sd(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.sd(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_prod_m[7,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,1],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,1])
res_prod_m[8,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,2],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,2])
res_prod_m[7,3,h] <- ifelse(totrep >0, RI_plot("mgt_man",treatment , ctrls,w_int="weights", dta_ind, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,4],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta_ind))$coefficients[2,4]))
res_prod_m[8,3,h] <- nobs(lm(as.formula(paste("outcome",treatment, sep="~")) ,data=dta_ind))
