...
source("/home/bjvca/data/projects/digital green/endline/data/init.R")
baseline <- read.csv("/home/bjvca/data/projects/digital green/endline/data/raw/baseline.csv")[c("hhid","maizeeduc","maizehh_no","maizeprrooms","maizedist_shop","maizemobile","maizeage","maizeprinfo_receiv","maizeprwall","maizeprearn","maizeprinfo_receiv_spouse","maizearea_cultivation","maizebags_harv")]
