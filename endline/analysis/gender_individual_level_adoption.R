...
out_sp2 = c("spouse2grp_sp1f29","spouse2grp_sp2g29","spouse2grp_sp3h29","spouse2group_sp4j29","spouse2grp5_sp5k29")
dta[out_sp1] <- dta[out_sp1] == "Yes"
dta[out_sp2] <- dta[out_sp2] == "Yes"
...
res_adopt[9,1,h] <- ifelse(h ==1, wtd.mean(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.mean(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.mean(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_adopt[10,1,h] <- ifelse(h ==1, wtd.sd(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.sd(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.sd(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_adopt[9,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,1],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,1])
res_adopt[10,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,2],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,2])
res_adopt[9,3,h] <- ifelse(totrep >0, RI_plot("mgt_man",treatment , ctrls,w_int="weights", dta, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,4],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta_ind))$coefficients[2,4]))
res_adopt[10,3,h] <- nobs(lm(as.formula(paste("time_prep_hh_mean",treatment, sep="~")) ,data=dta))
...
res_adopt[11,1,h] <- ifelse(h ==1, wtd.mean(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.mean(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.mean(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_adopt[12,1,h] <- ifelse(h ==1, wtd.sd(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.sd(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.sd(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_adopt[11,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,1],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,1])
res_adopt[12,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,2],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,2])
res_adopt[11,3,h] <- ifelse(totrep >0, RI_plot("mgt_man",treatment , ctrls,w_int="weights", dta, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,4],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta_ind))$coefficients[2,4]))
res_adopt[12,3,h] <- nobs(lm(as.formula(paste("time_prep_hh_mean",treatment, sep="~")) ,data=dta))
...
res_adopt[13,1,h] <- ifelse(h ==1, wtd.mean(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.mean(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.mean(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_adopt[14,1,h] <- ifelse(h ==1, wtd.sd(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.sd(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.sd(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_adopt[13,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,1],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,1])
res_adopt[14,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,2],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,2])
res_adopt[13,3,h] <- ifelse(totrep >0, RI_plot("mgt_man",treatment , ctrls,w_int="weights", dta, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,4],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta_ind))$coefficients[2,4]))
res_adopt[14,3,h] <- nobs(lm(as.formula(paste("time_prep_hh_mean",treatment, sep="~")) ,data=dta))
...
res_adopt_woman[9,1,h] <- ifelse(h ==1, wtd.mean(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.mean(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.mean(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_adopt_woman[10,1,h] <- ifelse(h ==1, wtd.sd(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.sd(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.sd(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_adopt_woman[9,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,1],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,1])
res_adopt_woman[10,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,2],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,2])
res_adopt_woman[9,3,h] <- ifelse(totrep >0, RI_plot("mgt_man",treatment , ctrls,w_int="weights", dta, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,4],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta_ind))$coefficients[2,4]))
res_adopt_woman[10,3,h] <- nobs(lm(as.formula(paste("time_prep_hh_mean",treatment, sep="~")) ,data=dta))
...
res_adopt_woman[11,1,h] <- ifelse(h ==1, wtd.mean(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.mean(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.mean(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_adopt_woman[12,1,h] <- ifelse(h ==1, wtd.sd(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.sd(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.sd(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_adopt_woman[11,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,1],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,1])
res_adopt_woman[12,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,2],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,2])
res_adopt_woman[11,3,h] <- ifelse(totrep >0, RI_plot("mgt_man",treatment , ctrls,w_int="weights", dta, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,4],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta_ind))$coefficients[2,4]))
res_adopt_woman[12,3,h] <- nobs(lm(as.formula(paste("time_prep_hh_mean",treatment, sep="~")) ,data=dta))
...
res_adopt_woman[13,1,h] <- ifelse(h ==1, wtd.mean(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.mean(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.mean(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_adopt_woman[14,1,h] <- ifelse(h ==1, wtd.sd(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.sd(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.sd(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_adopt_woman[13,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,1],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,1])
res_adopt_woman[14,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,2],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,2])
res_adopt_woman[13,3,h] <- ifelse(totrep >0, RI_plot("mgt_man",treatment , ctrls,w_int="weights", dta, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,4],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta_ind))$coefficients[2,4]))
res_adopt_woman[14,3,h] <- nobs(lm(as.formula(paste("time_prep_hh_mean",treatment, sep="~")) ,data=dta))
...
res_adopt_man[9,1,h] <- ifelse(h ==1, wtd.mean(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.mean(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.mean(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_adopt_man[10,1,h] <- ifelse(h ==1, wtd.sd(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.sd(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.sd(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_adopt_man[9,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,1],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,1])
res_adopt_man[10,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,2],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,2])
res_adopt_man[9,3,h] <- ifelse(totrep >0, RI_plot("mgt_man",treatment , ctrls,w_int="weights", dta, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,4],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta_ind))$coefficients[2,4]))
res_adopt_man[10,3,h] <- nobs(lm(as.formula(paste("time_prep_hh_mean",treatment, sep="~")) ,data=dta))
...
res_adopt_man[11,1,h] <- ifelse(h ==1, wtd.mean(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.mean(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.mean(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_adopt_man[12,1,h] <- ifelse(h ==1, wtd.sd(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.sd(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.sd(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_adopt_man[11,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,1],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,1])
res_adopt_man[12,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,2],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,2])
res_adopt_man[11,3,h] <- ifelse(totrep >0, RI_plot("mgt_man",treatment , ctrls,w_int="weights", dta, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,4],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta_ind))$coefficients[2,4]))
res_adopt_man[12,3,h] <- nobs(lm(as.formula(paste("time_prep_hh_mean",treatment, sep="~")) ,data=dta))
...
res_adopt_man[13,1,h] <- ifelse(h ==1, wtd.mean(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.mean(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.mean(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.mean(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_adopt_man[14,1,h] <- ifelse(h ==1, wtd.sd(dta_ind$outcome[dta_ind$recipient == "male" | dta_ind$recipient == "female"], dta_ind$weights[dta_ind$recipient == "male" | dta_ind$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), wtd.sd(dta_ind$outcome[dta_ind$recipient == "male"],dta_ind$weights[dta_ind$recipient == "male"], na.rm=T), ifelse( h == 5, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" | dta_ind$messenger == "female"],dta_ind$weights[dta_ind$messenger == "male" | dta_ind$messenger == "female"], na.rm=T), ifelse(h == 6, wtd.sd(dta_ind$outcome[dta_ind$messenger == "male" ],dta_ind$weights[dta_ind$messenger == "male" ], na.rm=T), wtd.sd(dta_ind$outcome[dta_ind$messenger != dta_ind$recipient],dta_ind$weights[dta_ind$messenger != dta_ind$recipient], na.rm=T)))))
res_adopt_man[13,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,1],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,1])
res_adopt_man[14,2,h] <- ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,2],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")) ,weights=weights,data=dta_ind))$coefficients[2,2])
res_adopt_man[13,3,h] <- ifelse(totrep >0, RI_plot("mgt_man",treatment , ctrls,w_int="weights", dta, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("outcome",treatment, sep="~")) ,weights=weights,data=dta_ind))$coefficients[2,4],summary(lm(as.formula(paste(paste("outcome",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta_ind))$coefficients[2,4]))
res_adopt_man[14,3,h] <- nobs(lm(as.formula(paste("time_prep_hh_mean",treatment, sep="~")) ,data=dta))
