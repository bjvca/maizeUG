...
res_know[1,1,h] <- ifelse(h ==1, mean(dta_bal$know_space_j[dta_bal$recipient == "male" | dta_bal$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), mean(dta_bal$know_space_j[dta_bal$recipient == "male"], na.rm=T), ifelse( h == 5, mean(dta_bal$know_space_j[dta_bal$messenger == "male" | dta_bal$messenger == "female"], na.rm=T), ifelse(h == 6, mean(dta_bal$know_space_j[dta_bal$messenger == "male" ], na.rm=T), mean(dta_bal$know_space_j[dta_bal$messenger != dta_bal$recipient], na.rm=T)))))
res_know[2,1,h] <-  ifelse(h ==1, sd(dta_bal$know_space_j[dta_bal$recipient == "male" | dta_bal$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), sd(dta_bal$know_space_j[dta_bal$recipient == "male"], na.rm=T), ifelse( h == 5, sd(dta_bal$know_space_j[dta_bal$messenger == "male" | dta_bal$messenger == "female"], na.rm=T), ifelse(h == 6, sd(dta_bal$know_space_j[dta_bal$messenger == "male" ], na.rm=T), sd(dta_bal$know_space_j[dta_bal$messenger != dta_bal$recipient], na.rm=T)))))
...
dta_bal <- balancr( h_ind = h, dta_in = dta, bal_var="know_combine_j")
res_know[3,1,h] <- ifelse(h ==1, mean(dta_bal$know_combine_j[dta_bal$recipient == "male" | dta_bal$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), mean(dta_bal$know_combine_j[dta_bal$recipient == "male"], na.rm=T), ifelse( h == 5, mean(dta_bal$know_combine_j[dta_bal$messenger == "male" | dta_bal$messenger == "female"], na.rm=T), ifelse(h == 6, mean(dta_bal$know_combine_j[dta_bal$messenger == "male" ], na.rm=T), mean(dta_bal$know_combine_j[dta_bal$messenger != dta_bal$recipient], na.rm=T)))))
res_know[4,1,h] <-  ifelse(h ==1, sd(dta_bal$know_combine_j[dta_bal$recipient == "male" | dta_bal$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), sd(dta_bal$know_combine_j[dta_bal$recipient == "male"], na.rm=T), ifelse( h == 5, sd(dta_bal$know_combine_j[dta_bal$messenger == "male" | dta_bal$messenger == "female"], na.rm=T), ifelse(h == 6, sd(dta_bal$know_combine_j[dta_bal$messenger == "male" ], na.rm=T), sd(dta_bal$know_combine_j[dta_bal$messenger != dta_bal$recipient], na.rm=T)))))
...
dta_bal <- balancr( h_ind = h, dta_in = dta, bal_var="know_weed_j")
res_know[5,1,h] <- ifelse(h ==1, mean(dta_bal$know_weed_j[dta_bal$recipient == "male" | dta_bal$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), mean(dta_bal$know_weed_j[dta_bal$recipient == "male"], na.rm=T), ifelse( h == 5, mean(dta_bal$know_weed_j[dta_bal$messenger == "male" | dta_bal$messenger == "female"], na.rm=T), ifelse(h == 6, mean(dta_bal$know_weed_j[dta_bal$messenger == "male" ], na.rm=T), mean(dta_bal$know_weed_j[dta_bal$messenger != dta_bal$recipient], na.rm=T)))))
res_know[6,1,h] <-  ifelse(h ==1, sd(dta_bal$know_weed_j[dta_bal$recipient == "male" | dta_bal$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), sd(dta_bal$know_weed_j[dta_bal$recipient == "male"], na.rm=T), ifelse( h == 5, sd(dta_bal$know_weed_j[dta_bal$messenger == "male" | dta_bal$messenger == "female"], na.rm=T), ifelse(h == 6, sd(dta_bal$know_weed_j[dta_bal$messenger == "male" ], na.rm=T), sd(dta_bal$know_weed_j[dta_bal$messenger != dta_bal$recipient], na.rm=T)))))
...
dta_bal <- balancr( h_ind = h, dta_in = dta, bal_var="know_armyworm_j")
res_know[7,1,h] <- ifelse(h ==1, mean(dta_bal$know_armyworm_j[dta_bal$recipient == "male" | dta_bal$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), mean(dta_bal$know_armyworm_j[dta_bal$recipient == "male"], na.rm=T), ifelse( h == 5, mean(dta_bal$know_armyworm_j[dta_bal$messenger == "male" | dta_bal$messenger == "female"], na.rm=T), ifelse(h == 6, mean(dta_bal$know_armyworm_j[dta_bal$messenger == "male" ], na.rm=T), mean(dta_bal$know_armyworm_j[dta_bal$messenger != dta_bal$recipient], na.rm=T)))))
res_know[8,1,h] <-  ifelse(h ==1, sd(dta_bal$know_armyworm_j[dta_bal$recipient == "male" | dta_bal$recipient == "female"], na.rm=T),ifelse(h %in% c(2,3,4), sd(dta_bal$know_armyworm_j[dta_bal$recipient == "male"], na.rm=T), ifelse( h == 5, sd(dta_bal$know_armyworm_j[dta_bal$messenger == "male" | dta_bal$messenger == "female"], na.rm=T), ifelse(h == 6, sd(dta_bal$know_armyworm_j[dta_bal$messenger == "male" ], na.rm=T), sd(dta_bal$know_armyworm_j[dta_bal$messenger != dta_bal$recipient], na.rm=T)))))
...
## balance on which variable? Just take first as if first is not missing, others will also be non-missing
...
####individual level knowledge - male co-head
