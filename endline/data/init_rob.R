###This file is adapted from init.R, which does most of the preparations for the main analysis - it is a robustnes check to see if our results are sensitive to the fact that some farmers had already started planting at the time of the first intervention

## the following robustness tests are/should be implemented
#1. due to climate change, farmers are more erratic in starting planting. A significant number of farmers appeard to already have planted at the time of the intervention. While the video shows many practices, some were related to planting and therefor may be less effective for early planters. We could rerun the analysis on a subset of the data, namely those that planted from august only.
#2. we now run the aggregate analysis on the average responses from both spouses. But in many cases, it seems one of the spouses does not really know, potentially introducing more measurement error. As a robustness check, we could rerun the analysis using only the info of the main manager of the plot.
#3. the video was shown twice, but there was some attrition in when we showed the video the second time. We could investigate if having seen the video only once leads to different results.
...
### all videos were shown between 2-24 of august 2017.
### as a robustness test, we also construct some of the outcomes where we only use data from plots that were planted *after* august 2017 
...
### make missing if planted before cutoff

dta$prod_pl1_sp1[((dta$grp1a9 < cutoff) | (dta$grp1a9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$prod_pl2_sp1[((dta$grp2b9 < cutoff) | (dta$grp2b9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$prod_pl3_sp1[((dta$grp3c9 < cutoff) | (dta$grp3c9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$prod_pl4_sp1[((dta$grp4d9 < cutoff) | (dta$grp4d9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$prod_pl5_sp1[((dta$grp5e9 < cutoff) | (dta$grp5e9 == 98)) & dta$messenger != 'ctrl'] <- NA
...
### make missing if planted before cutoff
dta$prod_pl1_sp2[((dta$spouse2grp_sp1f9 < cutoff) | (dta$spouse2grp_sp1f9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$prod_pl2_sp2[((dta$spouse2grp_sp2g9 < cutoff) | (dta$spouse2grp_sp2g9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$prod_pl3_sp2[((dta$spouse2grp_sp3h9 < cutoff) | (dta$spouse2grp_sp3h9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$prod_pl4_sp2[((dta$spouse2group_sp4j9 < cutoff) | (dta$spouse2group_sp4j9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$prod_pl5_sp2[((dta$spouse2grp5_sp5k9 < cutoff) | (dta$spouse2grp5_sp5k9 == 98))  & dta$messenger != 'ctrl'] <- NA
...
### also here explicitly set to 0 if sp1 and sp2 are missing
dta$prod_tot[is.na(dta$prod_tot_sp1) & is.na(dta$prod_tot_sp2)] <- NA
...
dta$area_pl1_sp1[((dta$grp1a9 < cutoff) | (dta$grp1a9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$area_pl2_sp1[((dta$grp2b9 < cutoff) | (dta$grp2b9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$area_pl3_sp1[((dta$grp3c9 < cutoff) | (dta$grp3c9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$area_pl4_sp1[((dta$grp4d9 < cutoff) | (dta$grp4d9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$area_pl5_sp1[((dta$grp5e9 < cutoff) | (dta$grp5e9 == 98)) & dta$messenger != 'ctrl'] <- NA
...
dta$yield_pl1_sp1[((dta$grp1a9 < cutoff) | (dta$grp1a9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$yield_pl2_sp1[((dta$grp2b9 < cutoff) | (dta$grp2b9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$yield_pl3_sp1[((dta$grp3c9 < cutoff) | (dta$grp3c9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$yield_pl4_sp1[((dta$grp4d9 < cutoff) | (dta$grp4d9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$yield_pl5_sp1[((dta$grp5e9 < cutoff) | (dta$grp5e9 == 98)) & dta$messenger != 'ctrl'] <- NA
...
dta$area_pl1_sp2[((dta$spouse2grp_sp1f9 < cutoff) | (dta$spouse2grp_sp1f9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$area_pl2_sp2[((dta$spouse2grp_sp2g9 < cutoff) | (dta$spouse2grp_sp2g9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$area_pl3_sp2[((dta$spouse2grp_sp3h9 < cutoff) | (dta$spouse2grp_sp3h9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$area_pl4_sp2[((dta$spouse2group_sp4j9 < cutoff) | (dta$spouse2group_sp4j9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$area_pl5_sp2[((dta$spouse2grp5_sp5k9 < cutoff) | (dta$spouse2grp5_sp5k9 == 98))  & dta$messenger != 'ctrl'] <- NA
...
dta$yield_pl1_sp2[((dta$spouse2grp_sp1f9 < cutoff) | (dta$spouse2grp_sp1f9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$yield_pl2_sp2[((dta$spouse2grp_sp2g9 < cutoff) | (dta$spouse2grp_sp2g9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$yield_pl3_sp2[((dta$spouse2grp_sp3h9 < cutoff) | (dta$spouse2grp_sp3h9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$yield_pl4_sp2[((dta$spouse2group_sp4j9 < cutoff) | (dta$spouse2group_sp4j9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$yield_pl5_sp2[((dta$spouse2grp5_sp5k9 < cutoff) | (dta$spouse2grp5_sp5k9 == 98))  & dta$messenger != 'ctrl'] <- NA
...
dta$grp1a18[((dta$grp1a9 < cutoff) | (dta$grp1a9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$grp2b18[((dta$grp2b9 < cutoff) | (dta$grp2b9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$grp3c18[((dta$grp3c9 < cutoff) | (dta$grp3c9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$grp4d18[((dta$grp4d9 < cutoff) | (dta$grp4d9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$grp5e18[((dta$grp5e9 < cutoff) | (dta$grp5e9 == 98)) & dta$messenger != 'ctrl'] <- NA
...
#dta$yield_better_sp1 <- rowSums(dta[c("grp1a18", "grp2b18","grp3c18","grp4d18","grp5e18")], na.rm=T)
...
dta$spouse2grp_sp1f18[((dta$spouse2grp_sp1f9 < cutoff) | (dta$spouse2grp_sp1f9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2grp_sp2g18[((dta$spouse2grp_sp2g9 < cutoff) | (dta$spouse2grp_sp2g9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2grp_sp3h18[((dta$spouse2grp_sp3h9 < cutoff) | (dta$spouse2grp_sp3h9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2group_sp4j18[((dta$spouse2group_sp4j9 < cutoff) | (dta$spouse2group_sp4j9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2grp5_sp5k18[((dta$spouse2grp5_sp5k9 < cutoff) | (dta$spouse2grp5_sp5k9 == 98))  & dta$messenger != 'ctrl'] <- NA
...
### use recommended spacing on *any* plot reported by any spouse
dta$grp1a201[((dta$grp1a9 < cutoff) | (dta$grp1a9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$grp2b201[((dta$grp2b9 < cutoff) | (dta$grp2b9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$grp3c201[((dta$grp3c9 < cutoff) | (dta$grp3c9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$grp4d201[((dta$grp4d9 < cutoff) | (dta$grp4d9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$grp5e201[((dta$grp5e9 < cutoff) | (dta$grp5e9 == 98)) & dta$messenger != 'ctrl'] <- NA
...
dta$spouse2grp_sp1f201[((dta$spouse2grp_sp1f9 < cutoff) | (dta$spouse2grp_sp1f9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2grp_sp2g201[((dta$spouse2grp_sp2g9 < cutoff) | (dta$spouse2grp_sp2g9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2grp_sp3h201[((dta$spouse2grp_sp3h9 < cutoff) | (dta$spouse2grp_sp3h9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2group_sp4j201[((dta$spouse2group_sp4j9 < cutoff) | (dta$spouse2group_sp4j9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2grp5_sp5k201[((dta$spouse2grp5_sp5k9 < cutoff) | (dta$spouse2grp5_sp5k9 == 98))  & dta$messenger != 'ctrl'] <- NA
...
dta$grp1a241[((dta$grp1a9 < cutoff) | (dta$grp1a9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$grp2b241[((dta$grp2b9 < cutoff) | (dta$grp2b9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$grp3c241[((dta$grp3c9 < cutoff) | (dta$grp3c9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$grp4d241[((dta$grp4d9 < cutoff) | (dta$grp4d9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$grp5e241[((dta$grp5e9 < cutoff) | (dta$grp5e9 == 98)) & dta$messenger != 'ctrl'] <- NA
...
dta$spouse2grp_sp1f241[((dta$spouse2grp_sp1f9 < cutoff) | (dta$spouse2grp_sp1f9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2grp_sp2g241[((dta$spouse2grp_sp2g9 < cutoff) | (dta$spouse2grp_sp2g9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2grp_sp3h241[((dta$spouse2grp_sp3h9 < cutoff) | (dta$spouse2grp_sp3h9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2group_sp4j241[((dta$spouse2group_sp4j9 < cutoff) | (dta$spouse2group_sp4j9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2grp5_sp5k241[((dta$spouse2grp5_sp5k9 < cutoff) | (dta$spouse2grp5_sp5k9 == 98))  & dta$messenger != 'ctrl'] <- NA
...
dta$grp1a26[((dta$grp1a9 < cutoff) | (dta$grp1a9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$grp2b246[((dta$grp2b9 < cutoff) | (dta$grp2b9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$grp3c246[((dta$grp3c9 < cutoff) | (dta$grp3c9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$grp4d246[((dta$grp4d9 < cutoff) | (dta$grp4d9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$grp5e246[((dta$grp5e9 < cutoff) | (dta$grp5e9 == 98)) & dta$messenger != 'ctrl'] <- NA
...
dta$spouse2grp_sp1f26[((dta$spouse2grp_sp1f9 < cutoff) | (dta$spouse2grp_sp1f9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2grp_sp2g26[((dta$spouse2grp_sp2g9 < cutoff) | (dta$spouse2grp_sp2g9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2grp_sp3h26[((dta$spouse2grp_sp3h9 < cutoff) | (dta$spouse2grp_sp3h9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2group_sp4j26[((dta$spouse2group_sp4j9 < cutoff) | (dta$spouse2group_sp4j9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2grp5_sp5k26[((dta$spouse2grp5_sp5k9 < cutoff) | (dta$spouse2grp5_sp5k9 == 98))  & dta$messenger != 'ctrl'] <- NA
...
dta$grp1a29[((dta$grp1a9 < cutoff) | (dta$grp1a9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$grp2b29[((dta$grp2b9 < cutoff) | (dta$grp2b9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$grp3c29[((dta$grp3c9 < cutoff) | (dta$grp3c9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$grp4d29[((dta$grp4d9 < cutoff) | (dta$grp4d9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$grp5e29[((dta$grp5e9 < cutoff) | (dta$grp5e9 == 98)) & dta$messenger != 'ctrl'] <- NA

dta[c("grp1a29","grp2b29", "grp3c29", "grp4d29", "grp5e29")] <- lapply(dta[c("grp1a29","grp2b29", "grp3c29", "grp4d29", "grp5e29")] , function(x) replace(x,is.na(x) , "No") )

dta$fert_sp1 <- ((dta$grp1a29 == "Yes") + (dta$grp2b29  == "Yes") + (dta$grp3c29  == "Yes") + (dta$grp4d29  == "Yes") + (dta$grp5e29  == "Yes")) > 0

dta$spouse2grp_sp1f29[((dta$spouse2grp_sp1f9 < cutoff) | (dta$spouse2grp_sp1f9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2grp_sp2g29[((dta$spouse2grp_sp2g9 < cutoff) | (dta$spouse2grp_sp2g9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2grp_sp3h29[((dta$spouse2grp_sp3h9 < cutoff) | (dta$spouse2grp_sp3h9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2group_sp4j29[((dta$spouse2group_sp4j9 < cutoff) | (dta$spouse2group_sp4j9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2grp5_sp5k29[((dta$spouse2grp5_sp5k9 < cutoff) | (dta$spouse2grp5_sp5k9 == 98))  & dta$messenger != 'ctrl'] <- NA

dta[c("spouse2grp_sp1f29","spouse2grp_sp2g29", "spouse2grp_sp3h29", "spouse2group_sp4j29", "spouse2grp5_sp5k29")] <- lapply(dta[c("spouse2grp_sp1f29","spouse2grp_sp2g29", "spouse2grp_sp3h29", "spouse2group_sp4j29", "spouse2grp5_sp5k29")] , function(x) replace(x,is.na(x) ,"No") )
...
dta$grp1a42[((dta$grp1a9 < cutoff) | (dta$grp1a9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$grp2b42[((dta$grp2b9 < cutoff) | (dta$grp2b9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$grp3c42[((dta$grp3c9 < cutoff) | (dta$grp3c9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$grp4d42[((dta$grp4d9 < cutoff) | (dta$grp4d9 == 98)) & dta$messenger != 'ctrl'] <- NA
dta$grp5e42[((dta$grp5e9 < cutoff) | (dta$grp5e9 == 98)) & dta$messenger != 'ctrl'] <- NA

dta[c("grp1a42","grp2b42", "grp3c42", "grp4d42", "grp5e42")] <- lapply(dta[c("grp1a42","grp2b42", "grp3c42", "grp4d42", "grp5e42")] , function(x) replace(x,is.na(x) , "No") )


dta$impseed_sp1 <- ((dta$grp1a42 == "Yes") + (dta$grp2b42  == "Yes") + (dta$grp3c42  == "Yes") + (dta$grp4d42  == "Yes") + (dta$grp5e42  == "Yes")) > 0

dta$spouse2grp_sp1f42[((dta$spouse2grp_sp1f9 < cutoff) | (dta$spouse2grp_sp1f9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2grp_sp2g42[((dta$spouse2grp_sp2g9 < cutoff) | (dta$spouse2grp_sp2g9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2grp_sp3h42[((dta$spouse2grp_sp3h9 < cutoff) | (dta$spouse2grp_sp3h9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2group_sp4j42[((dta$spouse2group_sp4j9 < cutoff) | (dta$spouse2group_sp4j9 == 98))  & dta$messenger != 'ctrl'] <- NA
dta$spouse2grp5_sp5k42[((dta$spouse2grp5_sp5k9 < cutoff) | (dta$spouse2grp5_sp5k9 == 98))  & dta$messenger != 'ctrl'] <- NA

dta[c("spouse2grp_sp1f42","spouse2grp_sp2g42", "spouse2grp_sp3h42", "spouse2group_sp4j42", "spouse2grp5_sp5k42")] <- lapply(dta[c("spouse2grp_sp1f42","spouse2grp_sp2g42", "spouse2grp_sp3h42", "spouse2group_sp4j42", "spouse2grp5_sp5k42")] , function(x) replace(x,is.na(x) ,"No") )
