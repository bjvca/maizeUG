...
### calculate plot level production - hh have max 5 plots
### if intercropped we have recoreded  a percentage (grpxx14)
### if pure stand (grpxx12 == "No") we set intercropped percentage to 100
### for spouse 1 
...
### missing code/DK code was 999 -> set to missing
...
#production - bags (grpxx16) x kg per bag (grpxx17) - spouse 1
### missing/DK code was 999 -> set to missing
...
### how do we handle missings? The below will also be 0 if nothing has been produced
dta$prod_tot_sp1 <- rowSums(dta[c("prod_pl1_sp1","prod_pl2_sp1","prod_pl3_sp1","prod_pl4_sp1", "prod_pl5_sp1")], na.rm=T)
### so explicitly make missing if missing on each plot
dta$prod_tot_sp1[is.na(dta$prod_pl1_sp1) & is.na(dta$prod_pl2_sp1) &is.na(dta$prod_pl3_sp1) &is.na(dta$prod_pl4_sp1) &is.na(dta$prod_pl5_sp1) ] <- NA
...
dta$prod_tot_sp2[is.na(dta$prod_pl1_sp2) & is.na(dta$prod_pl2_sp2) & is.na(dta$prod_pl3_sp2) & is.na(dta$prod_pl4_sp2) & is.na(dta$prod_pl5_sp2)] <- NA

## take mean of production reported by both spouses as total production
dta$prod_hh_mean <-  rowMeans(dta[c("prod_tot_sp1","prod_tot_sp2")], na.rm=T)
dta$prod_hh_mean[is.na(dta$prod_tot_sp1) & is.na(dta$prod_tot_sp2)] <- NA
dta$prod_hh_man <- NA
dta$prod_hh_man[dta$person_interviewed == "man"] <- dta$prod_tot_sp1[dta$person_interviewed == "man"]
dta$prod_hh_man[dta$person_interviewed == "woman"] <- dta$prod_tot_sp2[dta$person_interviewed == "woman"]
dta$prod_hh_woman <- NA
dta$prod_hh_woman[dta$person_interviewed == "woman"] <- dta$prod_tot_sp1[dta$person_interviewed == "woman"]
dta$prod_hh_woman[dta$person_interviewed == "man"] <- dta$prod_tot_sp2[dta$person_interviewed == "man"]
...
####################################################################  YIELD ############################################################################
dta$yield_hh_man <- dta$prod_hh_man/dta$area_hh_man
dta$yield_hh_man[dta$area_hh_man==0] <- NA
dta$yield_hh_woman <- dta$prod_hh_woman/dta$area_hh_woman
dta$yield_hh_woman[dta$area_hh_woman==0] <- NA

dta$yield_hh_mean <- rowMeans(dta[c("yield_hh_man","yield_hh_woman")], na.rm=T)
...
dta$mgt_both_woman_pl5[is.na((dta$grp5e10==3 ) ) & is.na((dta$spouse2grp5_sp5k10==3 ))] <- NA
...
dta$mgt_man_woman_pl5[is.na((dta$grp5e10==3 ) ) & is.na((dta$spouse2grp5_sp5k10==3 ))] <- NA
...
dta$decDAP_woman_pl1 <- rowSums(cbind((dta$grp1a31==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp1f31==1  & dta$person_interviewed=="man")), na.rm=T) >0
### if maize was planted
dta$decDAP_woman_pl1[is.na(dta$grp1a10 ) & is.na((dta$spouse2grp_sp1f10 ))] <- NA
dta$decUrea_woman_pl1 <- rowSums(cbind((dta$grp1a30a==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp1f30a==1  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decUrea_woman_pl1[is.na(dta$grp1a10 ) & is.na((dta$spouse2grp_sp1f10 ))] <- NA
dta$decOrg_woman_pl1 <- rowSums(cbind((dta$grp1a37a==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp1f37a==1  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOrg_woman_pl1[is.na(dta$grp1a10 ) & is.na((dta$spouse2grp_sp1f10 ))] <- NA

dta$decDAP_both_woman_pl1 <- rowSums(cbind((dta$grp1a31==3  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp1f31==3  & dta$person_interviewed=="man")), na.rm=T) >0
### if maize was planted
dta$decDAP_both_woman_pl1[is.na(dta$grp1a10 ) & is.na((dta$spouse2grp_sp1f10 ))] <- NA
dta$decUrea_both_woman_pl1 <- rowSums(cbind((dta$grp1a30a==3  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp1f30a==3  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decUrea_both_woman_pl1[is.na(dta$grp1a10 ) & is.na((dta$spouse2grp_sp1f10 ))] <- NA
dta$decOrg_both_woman_pl1 <- rowSums(cbind((dta$grp1a37a==3  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp1f37a==3  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOrg_both_woman_pl1[is.na(dta$grp1a10 ) & is.na((dta$spouse2grp_sp1f10 ))] <- NA


dta$decDAP_man_woman_pl1 <-  rowSums(cbind((dta$grp1a31==2  & dta$person_interviewed=="woman") ,  (dta$spouse2grp_sp1f31==2 & dta$person_interviewed=="man")), na.rm=T)
dta$decDAP_man_woman_pl1[is.na(dta$grp1a10 ) & is.na((dta$spouse2grp_sp1f10 ))]  <- NA
dta$decDAP_man_woman_pl2 <-  rowSums(cbind((dta$grp2b31==2  & dta$person_interviewed=="woman") ,  (dta$spouse2grp_sp2g31==2 & dta$person_interviewed=="man")), na.rm=T)
dta$decDAP_man_woman_pl2[is.na(dta$grp2b10 ) & is.na((dta$spouse2grp_sp2g10 ))]  <- NA
dta$decDAP_man_woman_pl3 <-  rowSums(cbind((dta$grp3c31==2  & dta$person_interviewed=="woman") ,  (dta$spouse2grp_sp3h31==2 & dta$person_interviewed=="man")), na.rm=T)
dta$decDAP_man_woman_pl3[is.na(dta$grp3c10 ) & is.na((dta$spouse2grp_sp3h10 ))]  <- NA
dta$decDAP_man_woman_pl4 <-  rowSums(cbind((dta$grp4d31==2  & dta$person_interviewed=="woman") ,  (dta$spouse2group_sp4j31==2 & dta$person_interviewed=="man")), na.rm=T)
dta$decDAP_man_woman_pl4[is.na(dta$grp4d10 ) & is.na((dta$spouse2grp_sp4j10 ))]  <- NA
dta$decDAP_man_woman_pl5 <-  rowSums(cbind((dta$grp5e31==2  & dta$person_interviewed=="woman") ,  (dta$spouse2grp5_sp5k31==2 & dta$person_interviewed=="man")), na.rm=T)
dta$decDAP_man_woman_pl5[is.na(dta$grp5e10 ) & is.na((dta$spouse2grp_sp5k10 ))]  <- NA

dta$decUrea_man_woman_pl1 <-  rowSums(cbind((dta$grp1a30a==2  & dta$person_interviewed=="woman") ,  (dta$spouse2grp_sp1f30a==2 & dta$person_interviewed=="man")), na.rm=T)
dta$decUrea_man_woman_pl1[is.na(dta$grp1a10 ) & is.na((dta$spouse2grp_sp1f10 ))]  <- NA
dta$decUrea_man_woman_pl2 <-  rowSums(cbind((dta$grp2b30b==2  & dta$person_interviewed=="woman") ,  (dta$spouse2grp_sp2g30b==2 & dta$person_interviewed=="man")), na.rm=T)
dta$decUrea_man_woman_pl2[is.na(dta$grp2b10 ) & is.na((dta$spouse2grp_sp2g10 ))]  <- NA
dta$decUrea_man_woman_pl3 <-  rowSums(cbind((dta$grp3c30c==2  & dta$person_interviewed=="woman") ,  (dta$spouse2grp_sp3h30c==2 & dta$person_interviewed=="man")), na.rm=T)
dta$decUrea_man_woman_pl3[is.na(dta$grp3c10 ) & is.na((dta$spouse2grp_sp3h10 ))]  <- NA
dta$decUrea_man_woman_pl4 <-  rowSums(cbind((dta$grp4d30d==2  & dta$person_interviewed=="woman") ,  (dta$spouse2group_sp4j30j==2 & dta$person_interviewed=="man")), na.rm=T)
dta$decUrea_man_woman_pl4[is.na(dta$grp4d10 ) & is.na((dta$spouse2grp_sp4j10 ))]  <- NA
dta$decUrea_man_woman_pl5 <-  rowSums(cbind((dta$grp5e30e==2  & dta$person_interviewed=="woman") ,  (dta$spouse2grp5_sp5k30k==2 & dta$person_interviewed=="man")), na.rm=T)
dta$decUrea_man_woman_pl5[is.na(dta$grp5e10 ) & is.na((dta$spouse2grp_sp5k10 ))]  <- NA

dta$decOrg_man_woman_pl1 <-  rowSums(cbind((dta$grp1a37a==2  & dta$person_interviewed=="woman") ,  (dta$spouse2grp_sp1f37a==2 & dta$person_interviewed=="man")), na.rm=T)
dta$decOrg_man_woman_pl1[is.na(dta$grp1a10 ) & is.na((dta$spouse2grp_sp1f10 ))]  <- NA
dta$decOrg_man_woman_pl2 <-  rowSums(cbind((dta$grp2b37a==2  & dta$person_interviewed=="woman") ,  (dta$spouse2grp_sp2g37a==2 & dta$person_interviewed=="man")), na.rm=T)
dta$decOrg_man_woman_pl2[is.na(dta$grp2b10 ) & is.na((dta$spouse2grp_sp2g10 ))]  <- NA
dta$decOrg_man_woman_pl3 <-  rowSums(cbind((dta$grp3c37a==2  & dta$person_interviewed=="woman") ,  (dta$spouse2grp_sp3h37a==2 & dta$person_interviewed=="man")), na.rm=T)
dta$decOrg_man_woman_pl3[is.na(dta$grp3c10 ) & is.na((dta$spouse2grp_sp3h10 ))]  <- NA
dta$decOrg_man_woman_pl4 <-  rowSums(cbind((dta$grp4d37a==2  & dta$person_interviewed=="woman") ,  (dta$spouse2group_sp4j37a==2 & dta$person_interviewed=="man")), na.rm=T)
dta$decOrg_man_woman_pl4[is.na(dta$grp4d10 ) & is.na((dta$spouse2grp_sp4j10 ))]  <- NA
dta$decOrg_man_woman_pl5 <-  rowSums(cbind((dta$grp5e37a==2  & dta$person_interviewed=="woman") ,  (dta$spouse2grp5_sp5k37a==2 & dta$person_interviewed=="man")), na.rm=T)
dta$decOrg_man_woman_pl5[is.na(dta$grp5e10 ) & is.na((dta$spouse2grp_sp5k10 ))]  <- NA

dta$decHybrid_man_woman_pl1 <- rowSums(cbind((dta$grp1a43a==2  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp1f43a==2  & dta$person_interviewed=="man"), (dta$grp1a43h==2 & dta$person_interviewed=="woman") , (dta$spouse2grp_sp1f43h==2  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decHybrid_man_woman_pl1[is.na(dta$grp1a10 ) & is.na((dta$spouse2grp_sp1f10 ))] <- NA
dta$decOPV_man_woman_pl1 <- rowSums(cbind((dta$grp1a43o==2  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp1f43o==2  & dta$person_interviewed=="man"), (dta$grp1a43v==2  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp1f43v==2  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOPV_man_woman_pl1[is.na(dta$grp1a10 ) & is.na((dta$spouse2grp_sp1f10 ))] <- NA
dta$decHybrid_man_woman_pl2 <- rowSums(cbind((dta$grp2b43a==2  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp2g43a==2  & dta$person_interviewed=="man"), (dta$grp2b43h==2 & dta$person_interviewed=="woman") , (dta$spouse2grp_sp2g43h==2  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decHybrid_man_woman_pl2[is.na(dta$grp2b10 ) & is.na((dta$spouse2grp_sp2g10 ))] <- NA
dta$decOPV_man_woman_pl2 <- rowSums(cbind((dta$grp2b43o==2  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp2g43o==2  & dta$person_interviewed=="man"), (dta$grp2b43v==2  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp2g43v==2  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOPV_man_woman_pl2[is.na(dta$grp2b10 ) & is.na((dta$spouse2grp_sp2g10 ))] <- NA
dta$decHybrid_man_woman_pl3 <- rowSums(cbind((dta$grp3c43a==2  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp3h43a==2  & dta$person_interviewed=="man"), (dta$grp3c43h==2 & dta$person_interviewed=="woman") , (dta$spouse2grp_sp3h43h==2  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decHybrid_man_woman_pl3[is.na(dta$grp3c10 ) & is.na((dta$spouse2grp_sp3h10 ))] <- NA
dta$decOPV_man_woman_pl3 <- rowSums(cbind((dta$grp3c43o==2  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp3h43o==2  & dta$person_interviewed=="man"), (dta$grp3c43v==2  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp3h43v==2  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOPV_man_woman_pl3[is.na(dta$grp3c10 ) & is.na((dta$spouse2grp_sp3h10 ))] <- NA
dta$decHybrid_man_woman_pl4 <- rowSums(cbind((dta$grp4d43a==2  & dta$person_interviewed=="woman") , (dta$spouse2group_sp4j43a==2  & dta$person_interviewed=="man"), (dta$grp4d43h==2 & dta$person_interviewed=="woman") , (dta$spouse2group_sp4j43h==2  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decHybrid_man_woman_pl4[is.na(dta$grp4d10 ) & is.na((dta$spouse2group_sp4j10 ))] <- NA
dta$decOPV_man_woman_pl4 <- rowSums(cbind((dta$grp4d43o==2  & dta$person_interviewed=="woman") , (dta$spouse2group_sp4j43o==2  & dta$person_interviewed=="man"), (dta$grp4d43v==2  & dta$person_interviewed=="woman") , (dta$spouse2group_sp4j43v==2  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOPV_man_woman_p4[is.na(dta$grp4d10 ) & is.na((dta$spouse2group_sp4j10 ))] <- NA
dta$decHybrid_man_woman_pl5 <- rowSums(cbind((dta$grp5e43a==2  & dta$person_interviewed=="woman") , (dta$spouse2grp5_sp5k43a==2  & dta$person_interviewed=="man"), (dta$grp5e43h==2 & dta$person_interviewed=="woman") , (dta$spouse2grp5_sp5k43h==2  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decHybrid_man_woman_pl5[is.na(dta$grp5e10 ) & is.na((dta$spouse2grp5_sp5k10 ))] <- NA
dta$decOPV_man_woman_pl5 <- rowSums(cbind((dta$grp5e43o==2  & dta$person_interviewed=="woman") , (dta$spouse2grp5_sp5k43o==2  & dta$person_interviewed=="man"), (dta$grp5e43v==2  & dta$person_interviewed=="woman") , (dta$spouse2grp5_sp5k43v==2  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOPV_man_woman_p5[is.na(dta$grp5e10 ) & is.na((dta$spouse2grp5_sp5k10 ))] <- NA



##seed use
dta$decHybrid_woman_pl1 <- rowSums(cbind((dta$grp1a43a==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp1f43a==1  & dta$person_interviewed=="man"), (dta$grp1a43h==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp1f43h==1  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decHybrid_woman_pl1[is.na(dta$grp1a10 ) & is.na((dta$spouse2grp_sp1f10 ))] <- NA
dta$decOPV_woman_pl1 <- rowSums(cbind((dta$grp1a43o==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp1f43o==1  & dta$person_interviewed=="man"), (dta$grp1a43v==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp1f43v==1  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOPV_woman_pl1[is.na(dta$grp1a10 ) & is.na((dta$spouse2grp_sp1f10 ))] <- NA

dta$decHybrid_both_woman_pl1 <- rowSums(cbind((dta$grp1a43a==3  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp1f43a==3  & dta$person_interviewed=="man"), (dta$grp1a43h==3 & dta$person_interviewed=="woman") , (dta$spouse2grp_sp1f43h==3  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decHybrid_both_woman_pl1[is.na(dta$grp1a10 ) & is.na((dta$spouse2grp_sp1f10 ))] <- NA
dta$decOPV_both_woman_pl1 <- rowSums(cbind((dta$grp1a43o==3  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp1f43o==3  & dta$person_interviewed=="man"), (dta$grp1a43v==3  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp1f43v==3  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOPV_both_woman_pl1[is.na(dta$grp1a10 ) & is.na((dta$spouse2grp_sp1f10 ))] <- NA
...
dta$decDAP_woman_pl2 <- rowSums(cbind((dta$grp2b31==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp2g31==1  & dta$person_interviewed=="man")), na.rm=T) >0
### if maize was planted
dta$decDAP_woman_pl2[is.na(dta$grp2b10 ) & is.na((dta$spouse2grp_sp2g10 ))] <- NA
dta$decUrea_woman_pl2 <- rowSums(cbind((dta$grp2b30b==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp2g30b==1  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decUrea_woman_pl2[is.na(dta$grp2b10 ) & is.na((dta$spouse2grp_sp2g10 ))] <- NA
dta$decOrg_woman_pl2 <- rowSums(cbind((dta$grp2b37a==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp2g37a==1  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOrg_woman_pl2[is.na(dta$grp2b10 ) & is.na((dta$spouse2grp_sp2g10 ))] <- NA

dta$decDAP_both_woman_pl2 <- rowSums(cbind((dta$grp2b31==3  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp2g31==3  & dta$person_interviewed=="man")), na.rm=T) >0
### if maize was planted
dta$decDAP_both_woman_pl2[is.na(dta$grp2b10 ) & is.na((dta$spouse2grp_sp2g10 ))] <- NA
dta$decUrea_both_woman_pl2 <- rowSums(cbind((dta$grp2b30b==3  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp2g30b==3  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decUrea_both_woman_pl2[is.na(dta$grp2b10 ) & is.na((dta$spouse2grp_sp2g10 ))] <- NA
dta$decOrg_both_woman_pl2 <- rowSums(cbind((dta$grp2b37a==3  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp2g37a==3  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOrg_both_woman_pl2[is.na(dta$grp2b10 ) & is.na((dta$spouse2grp_sp2g10 ))] <- NA
##seed use
dta$decHybrid_woman_pl2 <- rowSums(cbind((dta$grp2b43a==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp2g43a==1  & dta$person_interviewed=="man"), (dta$grp2b43h==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp2g43h==1  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decHybrid_woman_pl2[is.na(dta$grp2b10 ) & is.na((dta$spouse2grp_sp2g10 ))] <- NA
dta$decOPV_woman_pl2 <- rowSums(cbind((dta$grp2b43o==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp2g43o==1  & dta$person_interviewed=="man"), (dta$grp2b43v==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp2g43v==1  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOPV_woman_pl2[is.na(dta$grp2b10 ) & is.na((dta$spouse2grp_sp2g10 ))] <- NA

dta$decHybrid_both_woman_pl2 <- rowSums(cbind((dta$grp2b43a==3  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp2g43a==3  & dta$person_interviewed=="man"), (dta$grp2b43h==3 & dta$person_interviewed=="woman") , (dta$spouse2grp_sp2g43h==3  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decHybrid_both_woman_pl2[is.na(dta$grp2b10 ) & is.na((dta$spouse2grp_sp2g10 ))] <- NA
dta$decOPV_both_woman_pl2 <- rowSums(cbind((dta$grp2b43o==3  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp2g43o==3  & dta$person_interviewed=="man"), (dta$grp2b43v==3  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp2g43v==3  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOPV_both_woman_pl2[is.na(dta$grp2b10 ) & is.na((dta$spouse2grp_sp2g10 ))] <- NA
...
dta$decDAP_woman_pl3 <- rowSums(cbind((dta$grp3c31==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp3h31==1  & dta$person_interviewed=="man")), na.rm=T) >0
### if maize was planted
dta$decDAP_woman_pl3[is.na(dta$grp3c10 ) & is.na((dta$spouse2grp_sp3h10 ))] <- NA
dta$decUrea_woman_pl3 <- rowSums(cbind((dta$grp3c30c==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp3h30c==1  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decUrea_woman_pl3[is.na(dta$grp3c10 ) & is.na((dta$spouse2grp_sp3h10 ))] <- NA
dta$decOrg_woman_pl3 <- rowSums(cbind((dta$grp3c37a==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp3h37a==1  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOrg_woman_pl3[is.na(dta$grp3c10 ) & is.na((dta$spouse2grp_sp3h10 ))] <- NA

dta$decDAP_both_woman_pl3 <- rowSums(cbind((dta$grp3c31==3  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp3h31==3  & dta$person_interviewed=="man")), na.rm=T) >0
### if maize was planted
dta$decDAP_both_woman_pl3[is.na(dta$grp3c10 ) & is.na((dta$spouse2grp_sp3h10 ))] <- NA
dta$decUrea_both_woman_pl3 <- rowSums(cbind((dta$grp3c30c==3  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp3h30c==3  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decUrea_both_woman_pl3[is.na(dta$grp3c10 ) & is.na((dta$spouse2grp_sp3h10 ))] <- NA
dta$decOrg_both_woman_pl3 <- rowSums(cbind((dta$grp3c37a==3  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp3h37a==3  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOrg_both_woman_pl3[is.na(dta$grp3c10 ) & is.na((dta$spouse2grp_sp3h10 ))] <- NA
##seed use
dta$decHybrid_woman_pl3 <- rowSums(cbind((dta$grp3c43a==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp3h43a==1  & dta$person_interviewed=="man"), (dta$grp3c43h==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp3h43h==1  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decHybrid_woman_pl3[is.na(dta$grp3c10 ) & is.na((dta$spouse2grp_sp3h10 ))] <- NA
dta$decOPV_woman_pl3 <- rowSums(cbind((dta$grp3c43o==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp3h43o==1  & dta$person_interviewed=="man"), (dta$grp3c43v==1  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp3h43v==1  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOPV_woman_pl3[is.na(dta$grp3c10 ) & is.na((dta$spouse2grp_sp3h10 ))] <- NA

dta$decHybrid_both_woman_pl3 <- rowSums(cbind((dta$grp3c43a==3  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp3h43a==3  & dta$person_interviewed=="man"), (dta$grp3c43h==3 & dta$person_interviewed=="woman") , (dta$spouse2grp_sp3h43h==3  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decHybrid_both_woman_pl3[is.na(dta$grp3c10 ) & is.na((dta$spouse2grp_sp3h10 ))] <- NA
dta$decOPV_both_woman_pl3 <- rowSums(cbind((dta$grp3c43o==3  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp3h43o==3  & dta$person_interviewed=="man"), (dta$grp3c43v==3  & dta$person_interviewed=="woman") , (dta$spouse2grp_sp3h43v==3  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOPV_both_woman_pl3[is.na(dta$grp3c10 ) & is.na((dta$spouse2grp_sp3h10 ))] <- NA
...
dta$decDAP_woman_pl4 <- rowSums(cbind((dta$grp4d31==1  & dta$person_interviewed=="woman") , (dta$spouse2group_sp4j31==1  & dta$person_interviewed=="man")), na.rm=T) >0
### if maize was planted
dta$decDAP_woman_pl4[is.na(dta$grp4d10 ) & is.na((dta$spouse2group_sp4j10 ))] <- NA
dta$decUrea_woman_pl4 <- rowSums(cbind((dta$grp4d30d==1  & dta$person_interviewed=="woman") , (dta$spouse2group_sp4j30j==1  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decUrea_woman_pl4[is.na(dta$grp4d10 ) & is.na((dta$spouse2group_sp4j10 ))] <- NA
dta$decOrg_woman_pl4 <- rowSums(cbind((dta$grp4d37a==1  & dta$person_interviewed=="woman") , (dta$spouse2group_sp4j37a==1  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOrg_woman_pl4[is.na(dta$grp4d10 ) & is.na((dta$spouse2group_sp4j10 ))] <- NA

dta$decDAP_both_woman_pl4 <- rowSums(cbind((dta$grp4d31==3  & dta$person_interviewed=="woman") , (dta$spouse2group_sp4j31==3  & dta$person_interviewed=="man")), na.rm=T) >0
### if maize was planted
dta$decDAP_both_woman_pl4[is.na(dta$grp4d10 ) & is.na((dta$spouse2group_sp4j10 ))] <- NA
dta$decUrea_both_woman_pl4 <- rowSums(cbind((dta$grp4d30d==3  & dta$person_interviewed=="woman") , (dta$spouse2group_sp4j30j==3  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decUrea_both_woman_pl4[is.na(dta$grp4d10 ) & is.na((dta$spouse2group_sp4j10 ))] <- NA
dta$decOrg_both_woman_pl4 <- rowSums(cbind((dta$grp4d37a==3  & dta$person_interviewed=="woman") , (dta$spouse2group_sp4j37a==3  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOrg_both_woman_pl4[is.na(dta$grp4d10 ) & is.na((dta$spouse2group_sp4j10 ))] <- NA
##seed use
dta$decHybrid_woman_pl4 <- rowSums(cbind((dta$grp4d43a==1  & dta$person_interviewed=="woman") , (dta$spouse2group_sp4j43a==1  & dta$person_interviewed=="man"), (dta$grp4d43h==1  & dta$person_interviewed=="woman") , (dta$spouse2group_sp4j43h==1  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decHybrid_woman_pl4[is.na(dta$grp4d10 ) & is.na((dta$spouse2group_sp4j10 ))] <- NA
dta$decOPV_woman_pl4 <- rowSums(cbind((dta$grp4d43o==1  & dta$person_interviewed=="woman") , (dta$spouse2group_sp4j43o==1  & dta$person_interviewed=="man"), (dta$grp4d43v==1  & dta$person_interviewed=="woman") , (dta$spouse2group_sp4j43v==1  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOPV_woman_pl4[is.na(dta$grp4d10 ) & is.na((dta$spouse2group_sp4j10 ))] <- NA

dta$decHybrid_both_woman_pl4 <- rowSums(cbind((dta$grp4d43a==3  & dta$person_interviewed=="woman") , (dta$spouse2group_sp4j43a==3  & dta$person_interviewed=="man"), (dta$grp4d43h==3 & dta$person_interviewed=="woman") , (dta$spouse2group_sp4j43h==3  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decHybrid_both_woman_pl4[is.na(dta$grp4d10 ) & is.na((dta$spouse2group_sp4j10 ))] <- NA
dta$decOPV_both_woman_pl4 <- rowSums(cbind((dta$grp4d43o==3  & dta$person_interviewed=="woman") , (dta$spouse2group_sp4j43o==3  & dta$person_interviewed=="man"), (dta$grp4d43v==3  & dta$person_interviewed=="woman") , (dta$spouse2group_sp4j43v==3  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOPV_both_woman_p4[is.na(dta$grp4d10 ) & is.na((dta$spouse2group_sp4j10 ))] <- NA
...
dta$decDAP_woman_pl5 <- rowSums(cbind((dta$grp5e31==1  & dta$person_interviewed=="woman") , (dta$spouse2grp5_sp5k31==1  & dta$person_interviewed=="man")), na.rm=T) >0
### if maize was planted
dta$decDAP_woman_pl5[is.na(dta$grp5e10 ) & is.na((dta$spouse2grp5_sp5k10 ))] <- NA
dta$decUrea_woman_pl5 <- rowSums(cbind((dta$grp5e30e==1  & dta$person_interviewed=="woman") , (dta$spouse2grp5_sp5k30k==1  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decUrea_woman_pl5[is.na(dta$grp5e10 ) & is.na((dta$spouse2grp5_sp5k10 ))] <- NA
dta$decOrg_woman_pl5 <- rowSums(cbind((dta$grp5e37a==1  & dta$person_interviewed=="woman") , (dta$spouse2grp5_sp5k37a==1  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOrg_woman_pl5[is.na(dta$grp5e10 ) & is.na((dta$spouse2grp5_sp5k10 ))] <- NA

dta$decDAP_both_woman_pl5 <- rowSums(cbind((dta$grp5e31==3  & dta$person_interviewed=="woman") , (dta$spouse2grp5_sp5k31==3  & dta$person_interviewed=="man")), na.rm=T) >0
### if maize was planted
dta$decDAP_both_woman_pl5[is.na(dta$grp5e10 ) & is.na((dta$spouse2grp5_sp5k10 ))] <- NA
dta$decUrea_both_woman_pl5 <- rowSums(cbind((dta$grp5e30e==3  & dta$person_interviewed=="woman") , (dta$spouse2grp5_sp5k30k==3  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decUrea_both_woman_pl5[is.na(dta$grp5e10 ) & is.na((dta$spouse2grp5_sp5k10 ))] <- NA
dta$decOrg_both_woman_pl5 <- rowSums(cbind((dta$grp5e37a==3  & dta$person_interviewed=="woman") , (dta$spouse2grp5_sp5k37a==3  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOrg_both_woman_pl5[is.na(dta$grp5e10 ) & is.na((dta$spouse2grp5_sp5k10 ))] <- NA
##seed use
dta$decHybrid_woman_pl5 <- rowSums(cbind((dta$grp5e43a==1  & dta$person_interviewed=="woman") , (dta$spouse2grp5_sp5k43a==1  & dta$person_interviewed=="man"), (dta$grp5e43h==1  & dta$person_interviewed=="woman") , (dta$spouse2grp5_sp5k43h==1  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decHybrid_woman_pl5[is.na(dta$grp5e10 ) & is.na((dta$spouse2grp5_sp5k10 ))] <- NA
dta$decOPV_woman_pl5 <- rowSums(cbind((dta$grp5e43o==1  & dta$person_interviewed=="woman") , (dta$spouse2grp5_sp5k43o==1  & dta$person_interviewed=="man"), (dta$grp5e43v==1  & dta$person_interviewed=="woman") , (dta$spouse2grp5_sp5k43v==1  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOPV_woman_pl5[is.na(dta$grp5e10 ) & is.na((dta$spouse2grp5_sp5k10 ))] <- NA

dta$decHybrid_both_woman_pl5 <- rowSums(cbind((dta$grp5e43a==3  & dta$person_interviewed=="woman") , (dta$spouse2grp5_sp5k43a==3  & dta$person_interviewed=="man"), (dta$grp5e43h==3 & dta$person_interviewed=="woman") , (dta$spouse2grp5_sp5k43h==3  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decHybrid_both_woman_pl5[is.na(dta$grp5e10 ) & is.na((dta$spouse2grp5_sp5k10 ))] <- NA
dta$decOPV_both_woman_pl5 <- rowSums(cbind((dta$grp5e43o==3  & dta$person_interviewed=="woman") , (dta$spouse2grp5_sp5k43o==3  & dta$person_interviewed=="man"), (dta$grp5e43v==3  & dta$person_interviewed=="woman") , (dta$spouse2grp5_sp5k43v==3  & dta$person_interviewed=="man")), na.rm=T) >0
dta$decOPV_both_woman_p5[is.na(dta$grp5e10 ) & is.na((dta$spouse2grp5_sp5k10 ))] <- NA
...
dta$yield_better_hh <- rowSums(dta[c("yield_better_sp1","yield_better_sp2")], na.rm=T) > 0
dta$yield_better_hh[is.na(dta$yield_better_sp1) & is.na(dta$yield_better_sp2)] <- NA
...
dta$sold_man_woman[is.na(dta$sold_man_woman)] <- 0
