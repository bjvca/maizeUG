...
res_inputs_w[3,1,h] <- ifelse(h ==5, wtd.mean(dta$adopt[dta$recipient == "male" & dta$messenger == "male"], dta$weights[dta$recipient == "male" & dta$messenger == "male"], na.rm=T),ifelse(h %in% c(1,2,3), wtd.mean(dta$adopt[dta$recipient == "male"],dta$weights[dta$recipient == "male"], na.rm=T), ifelse( h == 4, wtd.mean(dta$adopt[dta$messenger == "male"],dta$weights[dta$messenger == "male"], na.rm=T))))
res_inputs_w[4,1,h] <-  ifelse(h ==5, wtd.sd(dta$adopt[dta$recipient == "male" & dta$messenger == "male"], dta$weights[dta$recipient == "male" & dta$messenger == "male"], na.rm=T),ifelse(h %in% c(1,2,3), wtd.sd(dta$adopt[dta$recipient == "male"],dta$weights[dta$recipient == "male"], na.rm=T), ifelse( h == 4, wtd.sd(dta$adopt[dta$messenger == "male"],dta$weights[dta$messenger == "male"], na.rm=T))))
...
res_inputs_w[3,3,h] <- ifelse(totrep >0, RI("adopt",treatment , ctrls,w_int="weights", dta, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("adopt",treatment, sep="~")) ,weights=weights,data=dta))$coefficients[2,4],summary(lm(as.formula(paste(paste("adopt",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta))$coefficients[2,4]))
...
res_inputs_w[5,1,h] <- ifelse(h ==5, wtd.mean(dta$adopt[dta$recipient == "male" & dta$messenger == "male"], dta$weights[dta$recipient == "male" & dta$messenger == "male"], na.rm=T),ifelse(h %in% c(1,2,3), wtd.mean(dta$adopt[dta$recipient == "male"],dta$weights[dta$recipient == "male"], na.rm=T), ifelse( h == 4, wtd.mean(dta$adopt[dta$messenger == "male"],dta$weights[dta$messenger == "male"], na.rm=T))))
res_inputs_w[6,1,h] <-  ifelse(h ==5, wtd.sd(dta$adopt[dta$recipient == "male" & dta$messenger == "male"], dta$weights[dta$recipient == "male" & dta$messenger == "male"], na.rm=T),ifelse(h %in% c(1,2,3), wtd.sd(dta$adopt[dta$recipient == "male"],dta$weights[dta$recipient == "male"], na.rm=T), ifelse( h == 4, wtd.sd(dta$adopt[dta$messenger == "male"],dta$weights[dta$messenger == "male"], na.rm=T))))
...
res_inputs_w[5,3,h] <- ifelse(totrep >0, RI("adopt",treatment , ctrls,w_int="weights", dta, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("adopt",treatment, sep="~")) ,weights=weights,data=dta))$coefficients[2,4],summary(lm(as.formula(paste(paste("adopt",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta))$coefficients[2,4]))
...
res_inputs_w[7,1,h] <- ifelse(h ==5, wtd.mean(dta$adopt[dta$recipient == "male" & dta$messenger == "male"], dta$weights[dta$recipient == "male" & dta$messenger == "male"], na.rm=T),ifelse(h %in% c(1,2,3), wtd.mean(dta$adopt[dta$recipient == "male"],dta$weights[dta$recipient == "male"], na.rm=T), ifelse( h == 4, wtd.mean(dta$adopt[dta$messenger == "male"],dta$weights[dta$messenger == "male"], na.rm=T))))
res_inputs_w[8,1,h] <-  ifelse(h ==5, wtd.sd(dta$adopt[dta$recipient == "male" & dta$messenger == "male"], dta$weights[dta$recipient == "male" & dta$messenger == "male"], na.rm=T),ifelse(h %in% c(1,2,3), wtd.sd(dta$adopt[dta$recipient == "male"],dta$weights[dta$recipient == "male"], na.rm=T), ifelse( h == 4, wtd.sd(dta$adopt[dta$messenger == "male"],dta$weights[dta$messenger == "male"], na.rm=T))))
...
res_inputs_w[7,3,h] <- ifelse(totrep >0, RI("adopt",treatment , ctrls,w_int="weights", dta, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("adopt",treatment, sep="~")) ,weights=weights,data=dta))$coefficients[2,4],summary(lm(as.formula(paste(paste("adopt",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta))$coefficients[2,4]))
...
res_inputs_w[9,1,h] <- ifelse(h ==5, wtd.mean(dta$adopt[dta$recipient == "male" & dta$messenger == "male"], dta$weights[dta$recipient == "male" & dta$messenger == "male"], na.rm=T),ifelse(h %in% c(1,2,3), wtd.mean(dta$adopt[dta$recipient == "male"],dta$weights[dta$recipient == "male"], na.rm=T), ifelse( h == 4, wtd.mean(dta$adopt[dta$messenger == "male"],dta$weights[dta$messenger == "male"], na.rm=T))))
res_inputs_w[10,1,h] <-  ifelse(h ==5, wtd.sd(dta$adopt[dta$recipient == "male" & dta$messenger == "male"], dta$weights[dta$recipient == "male" & dta$messenger == "male"], na.rm=T),ifelse(h %in% c(1,2,3), wtd.sd(dta$adopt[dta$recipient == "male"],dta$weights[dta$recipient == "male"], na.rm=T), ifelse( h == 4, wtd.sd(dta$adopt[dta$messenger == "male"],dta$weights[dta$messenger == "male"], na.rm=T))))
...
res_inputs_w[9,3,h] <- ifelse(totrep >0, RI("adopt",treatment , ctrls,w_int="weights", dta, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("adopt",treatment, sep="~")) ,weights=weights,data=dta))$coefficients[2,4],summary(lm(as.formula(paste(paste("adopt",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta))$coefficients[2,4]))
...
res_inputs_w[13,1:3,h] <- RI_FWER(deps= c( "mgt_woman"  ,  "dectime_woman", "decspace_woman", "decstriga_woman","decweed_woman") ,indep = treatment , ctrls = ctrls,dta =dta, p_vals = res_inputs_w[c(1,3,5,7,9),3,h], nr_repl = totrep,h_int=h, w_int="weights")
...
res_inputs_b[1,1,h] <- ifelse(h ==5, wtd.mean(dta$adopt[dta$recipient == "male" & dta$messenger == "male"], dta$weights[dta$recipient == "male" & dta$messenger == "male"], na.rm=T),ifelse(h %in% c(1,2,3), wtd.mean(dta$adopt[dta$recipient == "male"],dta$weights[dta$recipient == "male"], na.rm=T), ifelse( h == 4, wtd.mean(dta$adopt[dta$messenger == "male"],dta$weights[dta$messenger == "male"], na.rm=T))))
res_inputs_b[2,1,h] <-  ifelse(h ==5, wtd.sd(dta$adopt[dta$recipient == "male" & dta$messenger == "male"], dta$weights[dta$recipient == "male" & dta$messenger == "male"], na.rm=T),ifelse(h %in% c(1,2,3), wtd.sd(dta$adopt[dta$recipient == "male"],dta$weights[dta$recipient == "male"], na.rm=T), ifelse( h == 4, wtd.sd(dta$adopt[dta$messenger == "male"],dta$weights[dta$messenger == "male"], na.rm=T))))
...
res_inputs_b[1,3,h] <- ifelse(totrep >0, RI("adopt",treatment , ctrls,w_int="weights", dta, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("adopt",treatment, sep="~")) ,weights=weights,data=dta))$coefficients[2,4],summary(lm(as.formula(paste(paste("adopt",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta))$coefficients[2,4]))
...
res_inputs_b[3,1,h] <- ifelse(h ==5, wtd.mean(dta$adopt[dta$recipient == "male" & dta$messenger == "male"], dta$weights[dta$recipient == "male" & dta$messenger == "male"], na.rm=T),ifelse(h %in% c(1,2,3), wtd.mean(dta$adopt[dta$recipient == "male"],dta$weights[dta$recipient == "male"], na.rm=T), ifelse( h == 4, wtd.mean(dta$adopt[dta$messenger == "male"],dta$weights[dta$messenger == "male"], na.rm=T))))
res_inputs_b[4,1,h] <-  ifelse(h ==5, wtd.sd(dta$adopt[dta$recipient == "male" & dta$messenger == "male"], dta$weights[dta$recipient == "male" & dta$messenger == "male"], na.rm=T),ifelse(h %in% c(1,2,3), wtd.sd(dta$adopt[dta$recipient == "male"],dta$weights[dta$recipient == "male"], na.rm=T), ifelse( h == 4, wtd.sd(dta$adopt[dta$messenger == "male"],dta$weights[dta$messenger == "male"], na.rm=T))))
...
res_inputs_b[3,3,h] <- ifelse(totrep >0, RI("adopt",treatment , ctrls,w_int="weights", dta, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("adopt",treatment, sep="~")) ,weights=weights,data=dta))$coefficients[2,4],summary(lm(as.formula(paste(paste("adopt",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta))$coefficients[2,4]))
...
res_inputs_b[5,1,h] <- ifelse(h ==5, wtd.mean(dta$adopt[dta$recipient == "male" & dta$messenger == "male"], dta$weights[dta$recipient == "male" & dta$messenger == "male"], na.rm=T),ifelse(h %in% c(1,2,3), wtd.mean(dta$adopt[dta$recipient == "male"],dta$weights[dta$recipient == "male"], na.rm=T), ifelse( h == 4, wtd.mean(dta$adopt[dta$messenger == "male"],dta$weights[dta$messenger == "male"], na.rm=T))))
res_inputs_b[6,1,h] <-  ifelse(h ==5, wtd.sd(dta$adopt[dta$recipient == "male" & dta$messenger == "male"], dta$weights[dta$recipient == "male" & dta$messenger == "male"], na.rm=T),ifelse(h %in% c(1,2,3), wtd.sd(dta$adopt[dta$recipient == "male"],dta$weights[dta$recipient == "male"], na.rm=T), ifelse( h == 4, wtd.sd(dta$adopt[dta$messenger == "male"],dta$weights[dta$messenger == "male"], na.rm=T))))
...
res_inputs_b[5,3,h] <- ifelse(totrep >0, RI("adopt",treatment , ctrls,w_int="weights", dta, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("adopt",treatment, sep="~")) ,weights=weights,data=dta))$coefficients[2,4],summary(lm(as.formula(paste(paste("adopt",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta))$coefficients[2,4]))
...
res_inputs_b[7,1,h] <- ifelse(h ==5, wtd.mean(dta$adopt[dta$recipient == "male" & dta$messenger == "male"], dta$weights[dta$recipient == "male" & dta$messenger == "male"], na.rm=T),ifelse(h %in% c(1,2,3), wtd.mean(dta$adopt[dta$recipient == "male"],dta$weights[dta$recipient == "male"], na.rm=T), ifelse( h == 4, wtd.mean(dta$adopt[dta$messenger == "male"],dta$weights[dta$messenger == "male"], na.rm=T))))
res_inputs_b[8,1,h] <-  ifelse(h ==5, wtd.sd(dta$adopt[dta$recipient == "male" & dta$messenger == "male"], dta$weights[dta$recipient == "male" & dta$messenger == "male"], na.rm=T),ifelse(h %in% c(1,2,3), wtd.sd(dta$adopt[dta$recipient == "male"],dta$weights[dta$recipient == "male"], na.rm=T), ifelse( h == 4, wtd.sd(dta$adopt[dta$messenger == "male"],dta$weights[dta$messenger == "male"], na.rm=T))))
...
res_inputs_b[7,3,h] <- ifelse(totrep >0, RI("adopt",treatment , ctrls,w_int="weights", dta, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("adopt",treatment, sep="~")) ,weights=weights,data=dta))$coefficients[2,4],summary(lm(as.formula(paste(paste("adopt",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta))$coefficients[2,4]))
...
res_inputs_b[9,1,h] <- ifelse(h ==5, wtd.mean(dta$adopt[dta$recipient == "male" & dta$messenger == "male"], dta$weights[dta$recipient == "male" & dta$messenger == "male"], na.rm=T),ifelse(h %in% c(1,2,3), wtd.mean(dta$adopt[dta$recipient == "male"],dta$weights[dta$recipient == "male"], na.rm=T), ifelse( h == 4, wtd.mean(dta$adopt[dta$messenger == "male"],dta$weights[dta$messenger == "male"], na.rm=T))))
res_inputs_b[10,1,h] <-  ifelse(h ==5, wtd.sd(dta$adopt[dta$recipient == "male" & dta$messenger == "male"], dta$weights[dta$recipient == "male" & dta$messenger == "male"], na.rm=T),ifelse(h %in% c(1,2,3), wtd.sd(dta$adopt[dta$recipient == "male"],dta$weights[dta$recipient == "male"], na.rm=T), ifelse( h == 4, wtd.sd(dta$adopt[dta$messenger == "male"],dta$weights[dta$messenger == "male"], na.rm=T))))
...
res_inputs_b[9,3,h] <- ifelse(totrep >0, RI("adopt",treatment , ctrls,w_int="weights", dta, nr_repl = totrep, h),ifelse(is.null(ctrls),summary(lm(as.formula(paste("adopt",treatment, sep="~")) ,weights=weights,data=dta))$coefficients[2,4],summary(lm(as.formula(paste(paste("adopt",treatment, sep="~"),ctrls, sep="+")),weights=weights,data=dta))$coefficients[2,4]))
...
res_inputs_b[11,1,h] <- ifelse(h ==5, wtd.mean(indexer[[3]]$index[dta$recipient == "male" & dta$messenger == "male"], dta$weights[dta$recipient == "male" & dta$messenger == "male"], na.rm=T),ifelse(h %in% c(1,2,3), wtd.mean(indexer[[3]]$index[dta$recipient == "male"],dta$weights[dta$recipient == "male"], na.rm=T), ifelse( h == 4, wtd.mean(indexer[[3]]$index[dta$messenger == "male"],dta$weights[dta$messenger == "male"], na.rm=T))))
res_inputs_b[12,1,h] <-  ifelse(h ==5, wtd.sd(indexer[[3]]$index[dta$recipient == "male" & dta$messenger == "male"], dta$weights[dta$recipient == "male" & dta$messenger == "male"], na.rm=T),ifelse(h %in% c(1,2,3), wtd.sd(indexer[[3]]$index[dta$recipient == "male"],dta$weights[dta$recipient == "male"], na.rm=T), ifelse( h == 4, wtd.sd(indexer[[3]]$index[dta$messenger == "male"],dta$weights[dta$messenger == "male"], na.rm=T))))
...
res_inputs_b[13,1:3,h] <- RI_FWER(deps= c( "mgt_woman"  ,  "dectime_woman", "decspace_woman", "decstriga_woman","decweed_woman") ,indep = treatment , ctrls = ctrls,dta =dta, p_vals = res_inputs_b[c(1,3,5,7,9),3,h], nr_repl = totrep,h_int=h, w_int="weights")
}
