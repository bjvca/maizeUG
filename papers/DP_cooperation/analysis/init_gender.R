...
dta$mgt_boht_woman_pl2[is.na((dta$grp2b10==1 ) ) & is.na((dta$spouse2grp_sp2g10==1 ))] <- NA
...
dta[c("grp1a431","grp2b431","grp3c431","grp4d431", "grp5e431")]  + dta[c("grp1a432","grp2b432","grp3c432","grp4d432", "grp5e432")]
