...
png("/home/bjvca/data/projects/digital green/papers/DP_cooperation/results/decsion_activities_update_woman.png", units="px", height=3200, width= 4200, res=600)
...
png("/home/bjvca/data/projects/digital green/papers/DP_cooperation/results/decsion_activities_update_man.png", units="px", height=3200, width= 4200, res=600)
...
dm <- dta[c("hhid","messenger",paste(paste(dec[i],"woman_pl",sep="_") ,1:5,sep=""))]
dw <- dta[c("hhid","messenger",paste(paste(dec[i],"both_man_pl",sep="_") ,1:5,sep=""))]

dta_long_m <- reshape(dm, direction = "long",varying = 3:7 ,v.names=paste(dec[i],"woman",sep="_") , idvar = "hhid")
dta_long_w <- reshape(dw, direction = "long",varying = 3:7 ,v.names=paste(dec[i],"both_man",sep="_") , idvar = "hhid")
dta_long <- merge(dta_long_m, dta_long_w)
dta_long$differ <- NA
dta_long$differ <- unlist((dta_long[paste(dec[i],"woman",sep="_")] ==1 & dta_long[paste(dec[i],"both_man",sep="_")]==1))
...
png("/home/bjvca/data/projects/digital green/papers/DP_cooperation/results/decsion_activities_joint_deception.png", units="px", height=3200, width= 4200, res=600)

barplot(as.matrix(t(df)), main="", ylab = "share of plots", cex.lab = 1.5, cex.main = 1.4, beside=TRUE, col=colours, ylim = c(0,.5))
legend("topleft", c("joint","female illusion of ctrl","male illusion of ctrl"), cex=1.3, bty="n", fill=colours)
dev.off()
...
png("/home/bjvca/data/projects/digital green/papers/DP_cooperation/results/labour_time_man.png", units="px", height=3200, width= 4200, res=600)
...
png("/home/bjvca/data/projects/digital green/papers/DP_cooperation/results/labour_time_woman.png", units="px", height=3200, width= 4200, res=600)
...
png("/home/bjvca/data/projects/digital green/papers/DP_cooperation/results/shirking.png", units="px", height=3200, width= 4200, res=600)
...
names(df) <- "hours"
df$task <- rownames(df)
png("/home/bjvca/data/projects/digital green/papers/DP_cooperation/results/equity.png", units="px", height=1500, width= 4200, res=600)
...
png("/home/bjvca/data/projects/digital green/papers/DP_cooperation/results/sales.png", units="px", height=3200, width= 4200, res=600)
par(mfrow=c(1,2)) 
barplot(as.matrix(df), main="quantity sold", ylab = "bags", cex.lab = 1.5, cex.main = 1.4, beside=TRUE, col=colours)
...
barplot(as.matrix(df), main="revenue from sales", ylab = "USD", cex.lab = 1.5, cex.main = 1.4, beside=TRUE, col=colours)
...
dta$man_hiding_income <- dta$income_man - dta$income_man_woman
dta$woman_hiding_income <- dta$income_woman - dta$income_woman_man
...
png("/home/bjvca/data/projects/digital green/papers/DP_cooperation/results/likert_plot_tell_each_other.png", units="px", height=3200, width= 4200, res=600)
