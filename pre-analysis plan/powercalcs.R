...
Y0$Z.sim <- sample(as.factor(c(rep("Ctrl",N/10), rep("YMM", N/10),rep("YMF", N/10),rep("YMB", N/10), rep("YFM", N/10), rep("YFF", N/10), rep("YFB", N/10), rep("YBM", N/10), rep("YBF", N/10), rep("YBB", N/10))))
...
### model effects
    ...
    Y0$yld[Y0$Z.sim == "YMF"] <- Y0$yld[Y0$Z.sim == "YMF"] * ( 1 + .05)  
     Y0$yld[Y0$Z.sim == "YMB"] <- Y0$yld[Y0$Z.sim == "YMB"] * ( 1 + .20) 
        Y0$yld[Y0$Z.sim == "YFM"] <- Y0$yld[Y0$Z.sim == "YFM"] * ( 1 + .025) 
        Y0$yld[Y0$Z.sim == "YFF"] <- Y0$yld[Y0$Z.sim == "YFF"] * ( 1 + .075) 
        Y0$yld[Y0$Z.sim == "YFB"] <- Y0$yld[Y0$Z.sim == "YFB"] * ( 1 + .175) 
        Y0$yld[Y0$Z.sim == "YBM"] <- Y0$yld[Y0$Z.sim == "YBM"] * ( 1 + .15) 
        Y0$yld[Y0$Z.sim == "YBF"] <- Y0$yld[Y0$Z.sim == "YBF"] * ( 1 + .125) 
      Y0$yld[Y0$Z.sim == "YBB"] <- Y0$yld[Y0$Z.sim == "YBB"] * ( 1 + .225) 
